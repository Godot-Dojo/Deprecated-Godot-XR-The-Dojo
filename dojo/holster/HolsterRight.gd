...
func _physics_process(delta):
	global_transform.basis = get_parent().get_parent().camera_node.global_transform.basis


func _on_HolsterRight_body_entered(body):
	_on_Snap_Zone_body_entered(body) # Replace with function body.


func _on_HolsterRight_body_exited(body):
