...
func _ready():
	...
	if current_scene.get_filename() == "res://demo/scenes/Godot Dojo.tscn":
		scene_match = "three_shadows"
	if current_scene.get_filename() == "res://demo/scenes/Godot Dojo_Female.tscn":
		scene_match = "female_avatar"
	if current_scene.get_filename() == "res://demo/scenes/Godot Dojo_Shurikens.tscn":
		scene_match = "sybot"
...
func _on_Feature_RadialMenu_entry_selected(entry):
	if entry == scene_match:
		...
		get_tree().change_scene("res://demo/scenes/Godot Dojo.tscn")
	elif entry == "female_avatar":
		get_tree().change_scene("res://demo/scenes/Godot Dojo_Female.tscn")
	elif entry == "sybot":
		get_tree().change_scene("res://demo/scenes/Godot Dojo_Shurikens.tscn")
	elif entry == "mixamo":
